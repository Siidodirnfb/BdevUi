-- BdevUi - High Quality Roblox UI Library
-- Version 1.0.0
-- Created by Bdev Team
...
BdevUi.Theme = {
    ...
    SecondaryBackground = Color3.fromRGB(25, 25, 25), -- Slightly lighter dark gray
    TertiaryBackground = Color3.fromRGB(35, 35, 35), -- Even lighter dark gray

    -- Text Colors
    Text = Color3.fromRGB(255, 255, 255),      -- White text
    TextSecondary = Color3.fromRGB(200, 200, 200), -- Light gray text
    TextTertiary = Color3.fromRGB(150, 150, 150), -- Medium gray text

    -- Border Colors
    Border = Color3.fromRGB(45, 45, 45),       -- Dark gray borders
    BorderLight = Color3.fromRGB(75, 75, 75),  -- Lighter borders for hover states

    -- Interactive Colors
    Hover = Color3.fromRGB(55, 55, 55),        -- Hover background
    Selected = Color3.fromRGB(85, 85, 85),     -- Selected state
    Disabled = Color3.fromRGB(40, 40, 40),     -- Disabled state

    -- Special Colors
    Success = Color3.fromRGB(100, 255, 100),   -- Green for success
    Warning = Color3.fromRGB(255, 255, 100),   -- Yellow for warning
    Error = Color3.fromRGB(255, 100, 100),     -- Red for error
...
function BdevUi.Components.Tab:UpdateCanvasSize()
    -- Calculate total height based on elements
    local totalHeight = 0
...
function BdevUi.Components.Toggle.new(Tab, Text, Default, Callback)
    ...
    self.ToggleButton.Position = UDim2.new(1, -45, 0.5, -10)
...
function BdevUi.Notification.new(Title, Text, Duration)
    ...
    if not BdevUi._notificationGui then
        ...
        if not success then
            local player = Players.LocalPlayer
            if player then
                BdevUi._notificationGui.Parent = player:WaitForChild("PlayerGui")
            end
        end
    end
...
function BdevUi:Destroy()
    ...
    if BdevUi._notificationGui then
        BdevUi._notificationGui:Destroy()
